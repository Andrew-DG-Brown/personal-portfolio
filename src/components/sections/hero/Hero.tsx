                            ...
                            <ul className="flex">
                                ...
                                >
                                    <span className="mr-2">
                                        ...
                                        <img src="/images/skills icons/logo-github.svg" alt="github logo" className="w-[1.43em] bg-dark rounded-full pl-[0.2rem] py-[0.2rem] pr-[0.17rem]" />
                                    </span>
                                    GitHub
                                </a>
                                </li>
