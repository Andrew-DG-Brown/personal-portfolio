		...
		>
			<div className="container max-w-[1320px]">
				<div className="flex flex-wrap -mx-4">
					<div className="flex flex-col justify-center w-full lg:w-5/12 px-4">
						<div className="hero-content fadeInLeft">
							<h1 className="text-dark font-bold text-6xl leading-snug mb-1">
								Andrew Brown
								<br />
							</h1>
							...
							<ul className="flex">
								...
								<li>
									...
									>
										<span className="mr-2">
											<img
												src="/images/skills icons/logo-github.svg"
												alt="github logo"
												className="w-[1.43em] bg-dark rounded-full pl-[0.2rem] py-[0.2rem] pr-[0.17rem]"
											/>
										</span>
										GitHub
									</a>
							...
							<div className="ud flex flex-col clients pt-16">
								<p className="font-normal text-xl flex items-center text-body-color mb-2">
									My Skills
									<span className="w-8 h-[2px] bg-body-color inline-block ml-2"></span>
								</p>
								{/* <!-- skills list  --> */}
					...
					<div className="flex items-center w-full lg:w-6/12 px-4 wow fadeInRight">
						<div className="flex justify-center md:justify-end lg:text-right lg:ml-auto">
							<div className="relative inline-block pt-11 lg:pt-0 w-[80%]">
								<div
									className="relative max-w-full lg:ml-auto rounded-xl shadow-xl overflow-hidden bg-me"
									style={{ borderTopLeftRadius: "100px" }}
								>
									<img src="/images/hero/me.jpg" alt="hero background" />
								</div>
								{/* <!-- dots --> */}
