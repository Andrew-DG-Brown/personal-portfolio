            ...
            style={{overflow: 'hidden'}}>
                ...
                <div className="border-b border-[#E9ECF8] pb-[70px]">
                    ...
                    <div className="w-full px-4">
                        ...
                        <span className="font-semibold text-lg text-primary block mb-2"> Current/Previous roles </span>
                        <h2 className="font-bold text-black text-3xl sm:text-4xl md:text-[45px] mb-5">Experience</h2>
                        </div>
                    </div>
                    </div>
                    ...
                    <div className="flex flex-wrap -mx-4">
                        ...
                        <div className="lg:max-w-[428px] xl:max-w-[490px] w-full ml-auto pl-8 sm:pl-11 lg:pl-0 lg:pr-0 lg:mr-5 lg:text-right relative pb-12">
                            ...
                            <h3 className="font-semibold text-xl text-black mb-1">Hubio Technology</h3>
                            <p className="font-semibold text-base text-body-color mb-3">Full Stack Software Developer - Full Time</p>
                            <span className="inline-flex items-center justify-center py-2 px-4 rounded-full bg-primary text-white text-xs font-semibold mb-5"> Sept 2022 - present </span>
                        </div>
                        </div>
                        ...
                        <div className="lg:max-w-[428px] xl:max-w-[490px] w-full pl-8 sm:pl-11 lg:pl-0 lg:ml-5 relative pb-12">
                            ...
                            <h3 className="font-semibold text-xl text-black mb-1">KMER Consulting</h3>
                            <p className="font-semibold text-base text-body-color mb-3">Full Stack Web Developer - Contract (Full Time)</p>
                            <span className="inline-flex items-center justify-center py-2 px-4 rounded-full bg-primary text-white text-xs font-semibold mb-5"> Apr 2022 - Sept 2022 </span>
                        </div>
                        </div>
                        <div className="w-full lg:w-1/2 px-4">
                        <div className="lg:max-w-[428px] xl:max-w-[490px] w-full ml-auto pl-8 sm:pl-11 lg:pl-0 lg:pr-0 lg:mr-5 lg:text-right relative pb-12">
                            <span className="absolute top-1 left-0 lg:left-auto lg:-right-11 w-4 h-4 rounded-full bg-white border-4 border-primary"></span>
                            <h3 className="font-semibold text-xl text-black mb-1">Glistco LTD.</h3>
                            <p className="font-semibold text-base text-body-color mb-3">Frontend Web Developer - Full Time</p>
                            <span className="inline-flex items-center justify-center py-2 px-4 rounded-full bg-primary text-white text-xs font-semibold mb-5"> Jan 2021 - Apr 2022 </span>
                        </div>
                        </div>
                        <div className="w-full lg:w-1/2 px-4"></div>
                        <div className="w-full lg:w-1/2 px-4"></div>
