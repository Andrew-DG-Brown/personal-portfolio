...
function ColoredCard({ children, color = COLORS.PRIMARY }: Props) {
    return (
        <div className='mb-28 text-white'>
            <div className="container">
                <div style={{ backgroundColor: color }} className={`rounded-md relative overflow-hidden text-center py-[70px]`}>
                {children}
