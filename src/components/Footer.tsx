        ...
        <footer className="bg-black pt-[100px] pb-12 relative z-10">
            <div className="container">
                ...
                <div className="w-full md:w-1/2 lg:w-4/12 px-4">
                    <div className="mb-10">
                    <h2
                        className="font-bold text-white text-[44px] leading-tight mb-5"
                    >
                        Contact Info
                    </h2>
                    <h3
                        className="font-bold text-white opacity-70 text-2xl mb-2 hidden"
                    >
                        Contact Info
                    </h3>
                    <p className="font-medium text-base text-body-color mb-1">
                        andrew.dg.brown@gmail.com
                    </p>
                    <p className="font-medium text-base text-body-color mb-1 hidden">
