    ...
    return (
        <section
            ...
            <div className="container">
                ...
                <div
                    className="w-full lg:w-1/2 xl:w-7/12 px-4 mb-8 lg:mb-0"
                >
                    <span
                    className="font-bold text-primary text-lg md:text-xl mb-3"
                    >
                    ABOUT US
                    </span>
                    <h2
                    className="max-w-[400px] font-bold text-black text-3xl sm:text-4xl md:text-[45px] leading-tight sm:leading-tight md:leading-tight mb-5"
                    >
                    Better design, better experience
                    </h2>
                    <p
                    className="max-w-[570px] font-medium text-base text-body-color"
                    >
                ...
                <div className="w-full lg:w-1/2 xl:w-5/12 px-4">
                    <h3
                    className="font-semibold text-black text-2xl md:text-3xl mb-6"
                    >
                    Connect With Us
                    </h3>
