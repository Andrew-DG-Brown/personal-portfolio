export default function Team() {
    return (
        <section className="pt-20 lg:pt-[120px] hidden">
        <div className="container">
            <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4">
                <div
                className="text-center mx-auto mb-[60px] max-w-[510px]"
                >
                <span
            ...
            <div className="w-full md:w-1/2 xl:w-1/4 px-4">
                ...
                <div className="relative rounded-lg overflow-hidden">
                    ...
                    >
                    <div
                        className="bg-white relative rounded-lg overflow-hidden mx-5 py-5 px-3"
                    >
