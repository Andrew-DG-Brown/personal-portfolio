export default function Work() {
    return (
        ...
        <div className="container">
            ...
            <div className="w-full px-4">
                <div
                className="portfolio-buttons flex flex-wrap items-center justify-center mb-12"
                >
                <button
            ...
            <div className="w-full xl:w-10/12 px-4">
                <div
                className="items-wrapper flex flex-wrap justify-center mx-[-16px]"
                >
                <div className="w-full md:w-1/2 px-4 item web app">
                    <div className="mb-12">
                    <div
                        className="relative group mb-8 overflow-hidden shadow-service rounded-md"
                    >
                        <img
