function Testimonial() {
    return (            
    <section id="testimonial" className="hidden pt-[120px] pb-20">
        <div className="container">
            ...
            <div className="w-full px-4">
                ...
                {/* <!-- sub heading (hidden) --> */}
                <span
                    className="font-semibold text-lg text-primary mb-2 hidden"
                >
                    TESTIMONIAL
                </span>
                <h2
                ...
                <p className="font-medium text-lg text-body-color">
                    Hear what's been said about my work
                </p>
                </div>
            </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 px-4">
                <div
                className="bg-white rounded-xl relative overflow-hidden px-7 sm:px-10 p-10 shadow-testimonial mb-10"
                >
                <div className="mb-5">
                    <img
                    src="/images/testimonial/lineicons.svg"
                    alt="lineicons"
                    className="h-5"
                    />
                </div>
                ...
                <div className="flex items-center">
                    <div
                    className="max-w-[60px] w-full h-[60px] rounded-full overflow-hidden mr-3"
                    >
                    <img
            ...
            {/* <!-- second textimonial (hidden) --> */}
            <div className="w-full lg:w-1/2 px-4 hidden">
                <div
                className="bg-white rounded-xl relative overflow-hidden px-7 sm:px-10 p-10 shadow-testimonial mb-10"
                >
                <div className="mb-5">
                    <img
                    src="/images/testimonial/tailgrids.svg"
                    alt="tailgrids"
                    className="h-7"
                    />
                </div>
            ...
            <div className="w-full lg:w-1/2 px-4 hidden">
                ...
                <div className="mb-5">
                    <img
                    src="/images/testimonial/ayroui.svg"
                    alt="ayroui"
                    className="h-7"
                    />
                </div>
                ...
                <div className="flex items-center">
                    ...
                    >
                    <img
                        src="/images/testimonial/image-3.png"
                        alt="image"
                        className="w-full"
                    />
                    </div>
            ...
            <div className="w-full lg:w-1/2 px-4 hidden">
                ...
                <div className="mb-5">
                    <img
                    src="/images/testimonial/uideck.svg"
                    alt="uideck"
                    className="h-7"
                    />
                </div>
                ...
                <div className="flex items-center">
                    ...
                    >
                    <img
                        src="/images/testimonial/image-4.png"
                        alt="image"
                        className="w-full"
                    />
                    </div>
