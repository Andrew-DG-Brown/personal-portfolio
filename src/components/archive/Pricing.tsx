export default function Pricing() {
    return (            <section
        id="pricing"
        className="bg-white pt-20 lg:pt-[120px] relative z-20 overflow-hidden hidden"
        >
        <div className="container">
            <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4">
                <div
                className="text-center mx-auto mb-[60px] lg:mb-20 max-w-[510px]"
                >
                <span
            ...
            <div className="w-full md:w-1/2 lg:w-1/3 px-4">
                <div
                className="bg-white rounded-xl relative z-10 overflow-hidden border border-primary border-opacity-20 shadow-pricing py-10 px-8 sm:p-12 lg:py-10 lg:px-6 xl:px-10 2xl:p-12 mb-10"
                >
                <span
